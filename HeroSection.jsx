...
export const HeroSection = () => {
  ...
  const codeSnippets = [
    ...
    "// Projects: Auth System, Event Booking, E-Commerce",
    "",
    "developer.connect();",
    "console.log('🚀 Let us build something great together!');"
  ];
                        ...
                        <div 
                          ...
                          className={`
                            ...
                            ${line.includes("import") ? "text-purple-400 font-semibold" : 
                              ...
                              line.includes("JuniorDeveloper") ? "text-emerald-400 font-semibold" :
